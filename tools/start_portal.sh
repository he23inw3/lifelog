#!/usr/bin/env bash
# ============================================================
# LifeLog Account Portal Frontend 起動スクリプト（ローカル開発用）
#
# 使い方:
...
PORTAL_DIR="${PROJECT_ROOT}/app/lifelog-portal"
...
print_runtime_info() {
    ...
    echo -e "    App URL: ${BOLD}http://localhost:5174${RESET}"
    echo ""
}
