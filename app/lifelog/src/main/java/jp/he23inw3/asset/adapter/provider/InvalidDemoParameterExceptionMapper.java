...
/**
 * デモAPIパラメータ例外を HTTP 400 Bad Request にマッピングする ExceptionMapper。
 */
@Slf4j
@Provider
public class InvalidDemoParameterExceptionMapper implements ExceptionMapper<InvalidDemoParameterException> {

    @Override
    public Response toResponse(InvalidDemoParameterException exception) {
