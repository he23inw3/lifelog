...
/**
 * ユーザー初回登録バリデーション例外を HTTP 400 Bad Request にマッピングする ExceptionMapper。
 */
@Slf4j
@Provider
public class InvalidRegistrationExceptionMapper implements ExceptionMapper<InvalidRegistrationException> {

    @Override
    public Response toResponse(InvalidRegistrationException exception) {
